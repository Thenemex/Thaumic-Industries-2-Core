...
@Mod(modid = modID, useMetadata = true, version = "1.4.0.1", dependencies = dependencies)
public class ThaumicIndustries2Core{
    ...
    public static final String dependencies = "required-after:Thaumcraft@[4.2.3.5,);required-after:NemexLib@[1.2,);after:ForbiddenMagic;after:tc4tweak;after:WitchingGadgets";
}
