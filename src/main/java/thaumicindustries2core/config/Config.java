...
public class Config extends AConfig {
    ...
    public static boolean boneBow, campfire, flintAndSteel, golemCoreFishing, herobrineScythe, infusion, scribingTools, thaumometer, vanillaFurnace, crystalWell, seraphShoulders;
