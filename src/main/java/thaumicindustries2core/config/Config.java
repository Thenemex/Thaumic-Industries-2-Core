...
public class Config extends AConfig {
    ...
    public static boolean boneBow, campfire, flintAndSteel, golemCoreFishing, infusion, scribingTools, thaumometer, vanillaFurnace, crystalWell, seraphShoulders;
    ...
    protected void loadConfig() {
        ...
        comment(expert, "You can tweak off/on expert changes here");
        {
            ...
            flintAndSteel = newEntry("FlintAndSteel", "Sets a new arcane recipe, locked behind unlocking Thaumium");
