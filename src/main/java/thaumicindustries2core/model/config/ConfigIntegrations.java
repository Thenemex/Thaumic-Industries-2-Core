...
public class ConfigIntegrations {
    ...
    public static final String fm = "ForbiddenMagic", gt = "GardenTrees", mc = "MagicCookie", tb = "thaumicbases", tk = "benway_knowledge", wg = "WitchingGadgets";
    ...
    public static void init() {
        ...
        if (isModLoaded(gt, Config.gtEnabled)) new GardenTreesCompat(gt);
    }
}
